	...
	if track_ptr != nil {
		...
		if track_ptr.t_type == Track_Type_Track {
			...
			if track_ptr.used_by == 0 {
				return ("track " + txt + " , out of order: " + strconv.FormatBool(track_ptr.out_of_order) + " , not used , speed:" + strconv.FormatInt(track_ptr.data[T_max_speed], 10) + "kmph , " +
					"dist:" + strconv.FormatInt(track_ptr.data[T_distance], 10) + "km")
			} else {
				return ("track " + txt + " , out of order: " + strconv.FormatBool(track_ptr.out_of_order) + " , used by train[" + strconv.FormatInt(track_ptr.used_by, 10) + "] , " +
			...
			if track_ptr.used_by == 0 {
				return ("platform " + txt + " , out of order: " + strconv.FormatBool(track_ptr.out_of_order) + " , not used , delay:" + strconv.FormatInt(track_ptr.data[T_min_delay], 10) + "min")
			} else {
				return "platform " + txt + " , out of order: " + strconv.FormatBool(track_ptr.out_of_order) + " , used by train[" + strconv.FormatInt(track_ptr.used_by, 10) + "] , delay:" + strconv.FormatInt(track_ptr.data[T_min_delay], 10) + "min"
			}
		} else {
			if track_ptr.used_by == 0 {
				return "Service track " + txt + " , out of order: " + strconv.FormatBool(track_ptr.out_of_order) + " , not used"
			} else {
				return "Service track " + txt + " , out of order: " + strconv.FormatBool(track_ptr.out_of_order) + " , used by train[" + strconv.FormatInt(track_ptr.used_by, 10) + "]"
			}
		}
	} else {
		return "null"
